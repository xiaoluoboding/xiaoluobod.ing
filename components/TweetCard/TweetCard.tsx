...
import {
  ...
  type TweetProps,
  Tweet as ReactTweet,
  TweetSkeleton as ReactTweetSkeleton,
} from "react-tweet"
...
export const TweetSkeleton = ({
  ...
  >
    ...
    <div className="h-20 w-full bg-primary/10 rounded-md" />
  </div>
)
...
export const MagicTweet = ({
  ...
  return (
    <div
      className={cn(
        "relative flex text-primary border-none size-full max-w-lg flex-col gap-2 overflow-hidden rounded-lg border p-4 backdrop-blur-md",
        className
      )}
      {...props}
    >
...
export const TweetCard = async ({
  ...
  return (
    <div
      className={cn(
        "thumbnail-shadow outline-none relative w-full min-w-full overflow-hidden rounded-xl",
        props.className
      )}
    >
